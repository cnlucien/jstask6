...
angular.module('tm.pagination', []).directive('tmPagination', [function () {
  return {
    ...
    template: '<div class="p-2 page-list d-flex align-items-center justify-content-start flex-wrap">' +
        ...
        '到第<input type="text" ng-model="jumpPageNum"  />页 ' + '<button ng-click="jumpToPage()" class="ml-2 page-link">确认</button>' +
        '</div>' +
        '<div class="no-items" ng-show="conf.totalItems <= 0">暂无数据</div>' +
        '</div>',
    // '<div class="page-list">' +
// 				'<ul data-am-widget="pagination" class="pagination am-pagination am-pagination-default" ng-show="conf.totalItems > 0">' +
